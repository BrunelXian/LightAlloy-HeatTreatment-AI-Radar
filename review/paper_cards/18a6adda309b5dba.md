...
- Venue: arXiv
- DOI: 
- URL: http://arxiv.org/abs/2104.13199v1
- Source: arXiv
- Manual status: curated
- Manual notes: Relevant candidate for process-property modelling.
- Machine screening decision: CORE
- Relevance score: 14
- Screening reason: positive: aluminium, alloy, quenching, deep learning, neural network

## Tags
- alloy_system: Aluminium alloy
- heat_treatment_process: Quenching
- property_target: 
